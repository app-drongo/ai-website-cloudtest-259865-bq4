...
const DEFAULT_HERO = {
  badge: 'New: Edge Analytics Dashboard',
  title: 'Supercharge your web performance with',
  titleHighlight: 'CloudTest Analytics',
  description:
    'Monitor, optimize, and secure your web applications with real-time performance insights powered by global edge computing.',
  features: [
  ...
  imageAlt: 'CloudTest Analytics Dashboard',
  statsLabel1: 'Performance Boost',
  statsValue1: '3x Faster',
  statsLabel2: 'Global Coverage',
  statsValue2: '200+ Cities',
} as const;
