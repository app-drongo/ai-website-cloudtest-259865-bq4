...
export default function Footer({
  logoText = 'CloudTest',
  companyDescription = 'Comprehensive cloud testing platform for modern development teams. Automate your testing workflows, scale with confidence, and deliver quality software faster.',
  contactEmail = 'support@cloudtest.com',
  contactPhone = '+1 (555) 123-TEST',
  contactAddress = '123 Cloud Street, Tech District',
  newsletterTitle = 'Testing Updates',
  newsletterDisclaimer = 'Get the latest testing insights and platform updates. No spam, unsubscribe anytime.',
  section1Title = 'Platform',
  section2Title = 'Company',
  section3Title = 'Resources',
  section4Title = 'Legal',
  copyrightText = '© 2024 CloudTest. All rights reserved.',
  madeWithText = 'by testing experts',
  socialText = 'Follow us:',
  social1Href = 'https://twitter.com/cloudtest',
  social2Href = 'https://facebook.com/cloudtest',
  social3Href = 'https://instagram.com/cloudtest',
  social4Href = 'https://linkedin.com/company/cloudtest',
  social5Href = 'https://github.com/cloudtest',
}: FooterProps) {
  const footerSections = [
    {
      title: section1Title,
      links: [
        { name: 'Test Automation', href: '/automation' },
        { name: 'Load Testing', href: '/load-testing' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Testing Guides', href: '/guides' },
